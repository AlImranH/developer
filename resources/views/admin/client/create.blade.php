            ...
            <div class="card-body">
                <form action="{{ route('client.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="reviews" class="form-control @error('reviews') is-invalid @enderror" id="reviews" cols="30" rows="5"></textarea>
                        @error('reviews')
                        <div class="invalid-feedback">
                          {{ $message }}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <small id="image" class="form-text text-muted">image dimension: 190X190</small>
                    </div>
